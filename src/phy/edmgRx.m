function [syncError, rxDpPsdu,detSymbBlks,rxDataGrid,rxDataBlks, cirEst,trn,preamble]  = ...
...
%% Receiver processing
    if simParams.psduMode == 0
        %Full receiver
        [syncError, rxDpPsdu,detSymbBlks,rxDataGrid,rxDataBlks, ~,cirEst,trn, preamble] = ...
